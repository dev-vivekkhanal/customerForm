...
import circle from "../assets/circleLogo.jpeg";
    ...
    <main className="min-h-screen bg-[#fefefe]">
      <div className="w-full max-w-[30rem] mx-auto p-5 pt-0">
        <header className="flex justify-between items-center gap-5">
          ...
          <img src={circle} alt="circle" className="w-20" />
        </header>

        <section>
          <h1 className="mb-0 text-center text-2xl md:text-3xl font-semibold roboto-medium">
            How was your experience?
          </h1>
          <form className="text-[#1e1e1e] text-lg" onSubmit={onFormSubmit}>
